...
void SetupDisplayNames() {
    ...
    strcpy(itemTimestampDisplayName[ITEM_OCARINA_OF_TIME],           "Ocarina of Time:    ");
    ...
    strcpy(itemTimestampDisplayName[ITEM_LENS_OF_TRUTH],             "Lens of Truth:      ");
    strcpy(itemTimestampDisplayName[ITEM_HAMMER],                    "Megaton Hammer:     ");
    strcpy(itemTimestampDisplayName[ITEM_ARROW_LIGHT],               "Light Arrows:       ");
    strcpy(itemTimestampDisplayName[ITEM_BOTTLE_EMPTY],              "Bottle:             ");
    strcpy(itemTimestampDisplayName[ITEM_ZELDAS_LETTER],             "Zelda's Letter:     ");
    ...
    strcpy(itemTimestampDisplayName[ITEM_SWORD_BIGGORON],            "Biggoron's Sword:   ");
    ...
    strcpy(itemTimestampDisplayName[ITEM_STRENGTH_GORONS_BRACELET],  "Goron's Bracelet:   ");
    strcpy(itemTimestampDisplayName[ITEM_STRENGTH_SILVER_GAUNTLETS], "Silver Gauntlets:   ");
    strcpy(itemTimestampDisplayName[ITEM_STRENGTH_GOLD_GAUNTLETS],   "Gold Gauntlets:     ");
    ...
    strcpy(itemTimestampDisplayName[ITEM_ADULTS_WALLET],             "Adult's Wallet:     ");
    strcpy(itemTimestampDisplayName[ITEM_GIANTS_WALLET],             "Giant's Wallet:     ");
    strcpy(itemTimestampDisplayName[ITEM_WEIRD_EGG],                 "Weird Egg:          ");
    strcpy(itemTimestampDisplayName[ITEM_GERUDOS_CARD],              "Gerudo's Card:      ");
    ...
    strcpy(itemTimestampDisplayName[ITEM_MASK_BUNNY_HOOD],           "Bunny Hood:         ");
    strcpy(itemTimestampDisplayName[ITEM_ODD_MUSHROOM],              "Odd Mushroom:       ");
    strcpy(itemTimestampDisplayName[ITEM_ODD_POTION],                "Odd Potion:         ");
    strcpy(itemTimestampDisplayName[ITEM_POACHERS_SAW],              "Poacher's Saw:      ");
    strcpy(itemTimestampDisplayName[ITEM_BROKEN_GORONS_SWORD],       "Broken Goron Sword: ");
    strcpy(itemTimestampDisplayName[ITEM_PRESCRIPTION],              "Prescription:       ");
    strcpy(itemTimestampDisplayName[ITEM_EYEBALL_FROG],              "Eyeball Frog:       ");
    strcpy(itemTimestampDisplayName[ITEM_EYE_DROPS],                 "Eye Drops:          ");
    ...
    strcpy(itemTimestampDisplayName[ITEM_DUNGEON_BOSS_KEY],          "Ganon's Boss Key:   ");
    strcpy(itemTimestampDisplayName[ITEM_INVALID_1],                 "Magic:              ");
    strcpy(itemTimestampDisplayName[ITEM_INVALID_3],                 "Double Defense:     ");
