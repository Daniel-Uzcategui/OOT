    ...
    if (gPlayState != nullptr) {
        ...
        if (ImGui::BeginCombo("Sword", curSword)) {
            ...
            if (ImGui::Selectable("Biggoron's Sword")) {
                ...
                Inventory_ChangeEquipment(EQUIP_TYPE_SWORD, PLAYER_SWORD_BIGGORON);
            }
        ...
        if (ImGui::BeginCombo("Tunic", curTunic)) {
            ...
            if (ImGui::Selectable("Goron Tunic")) {
                ...
                Inventory_ChangeEquipment(EQUIP_TYPE_TUNIC, PLAYER_TUNIC_GORON + 1);
            }
            if (ImGui::Selectable("Zora Tunic")) {
                player->currentTunic = PLAYER_TUNIC_ZORA;
                Inventory_ChangeEquipment(EQUIP_TYPE_TUNIC, PLAYER_TUNIC_ZORA + 1);
            }
            ImGui::EndCombo();
        }
        ...
        if (ImGui::BeginCombo("Boots", curBoots)) {
            ...
            if (ImGui::Selectable("Iron Boots")) {
                ...
                Inventory_ChangeEquipment(EQUIP_TYPE_BOOTS, PLAYER_BOOTS_IRON + 1);
            }
            if (ImGui::Selectable("Hover Boots")) {
                player->currentBoots = PLAYER_BOOTS_HOVER;
                Inventory_ChangeEquipment(EQUIP_TYPE_BOOTS, PLAYER_BOOTS_HOVER + 1);
            }
            ImGui::EndCombo();
        }
